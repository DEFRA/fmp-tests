...
module.exports = {
  'happy-path-pin-postcode': function (client) {
    // Loop over each postcode
    data.pinpostcode.forEach(function (item) {
  ...
  'happy-path-pin-place': function (client) {
  // Loop over each place
    data.pinplace.forEach(function (item) {
      var location = item.location
      // var floodzone = item.floodzone
      var en = item.en
  ...
  'happy-path-pin-ngr': function (client) {
  // Loop over each place
    data.pinngr.forEach(function (item) {
      var location = item.location
      // var floodzone = item.floodzone
      var en = item.en
  ...
  'happy-path-pin-en': function (client) {
  // Loop over each Easting and Northing
    data.pineandn.forEach(function (item) {
